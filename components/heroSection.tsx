...
const HeroSection = () => {
    return (
        <div className="text-center flex flex-col items-center gap-4  lg:mt-8 w-full sm:w-[600px] md:w-[700px] lg:w-[800px] px-4">
            <h1 className="hidden lg:block text-3xl sm:text-4xl md:text-5xl font-extrabold text-white drop-shadow-lg tracking-wide">
            ...
            <p className="text-base sm:text-lg md:text-xl font-medium text-white/90 tracking-wide whitespace-nowrap">
                ...
                <span className="block lg:inline text-blue-300 font-bold"> A Full stack developer</span>
